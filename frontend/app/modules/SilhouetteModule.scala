...
import models.services.{ ToolService, ToolServiceImpl, UserService, UserServiceImpl }
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def configure() {
    ...
    bind[ToolService].to[ToolServiceImpl]
    bind[ToolDAO].to[ToolDAOImpl]
  ...
  /**
   * Provides the implementation of the delegable credentials auth info DAO.
   *
   * @param reactiveMongoApi The ReactiveMongo API.
   * @param config The Play configuration.
   * @return The implementation of the delegable credentials auth info DAO.
   */
  @Provides
